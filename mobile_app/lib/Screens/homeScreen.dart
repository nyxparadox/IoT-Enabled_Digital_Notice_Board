...
class _HomescreenState extends State<Homescreen> {
  ...
  Future<void> _handelSendNotice()async{
    ...
    try{
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Please provide message to send", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),), backgroundColor: Colors.red,), snackBarAnimationStyle: AnimationStyle(duration: Duration(milliseconds: 200), reverseDuration: Duration(milliseconds: 200)) );
      setState(() {
        _isloading = false;
      });
      return;
